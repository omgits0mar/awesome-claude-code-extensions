...
A large, source-backed index of Claude Code plugins, skills, agents, commands, hooks, workflows, MCP servers, interfaces, and supporting tools.
...
| Add installable Claude Code capabilities | [Plugins](catalog/by-kind/plugins.md) |
| Reuse focused instructions or lifecycle automation | [Skills, commands & hooks](catalog/by-kind/skills-commands-hooks.md) |
| Coordinate specialist agents or development processes | [Agents & workflows](catalog/by-kind/agents-workflows.md) |
| Connect Claude Code to external tools and data | [MCP servers](catalog/by-kind/mcp-servers.md) |
...
This repository aims to be broad and reproducible, but it does not claim literal completeness. GitHub search is capped and delayed; repositories move or disappear; one marketplace may contain hundreds of nested components; and the official MCP Registry includes both open- and closed-source services.
...
Authenticated GitHub search and official MCP Registry importers write to review queues; they never auto-publish candidates:
